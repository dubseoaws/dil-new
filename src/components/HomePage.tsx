...
import { GoogleG, GoogleStars } from './GoogleMarks'
...
export function HomePage() {
  return <main id="main">
    <section className="hero hero-with-videos"><div className="container hero-inner"><div className="hero-content"><div className="hero-introduction"><span className="eyebrow"><span />Established implant clinic in London</span><h1>Dental Implants<br /><em>London.</em></h1><a className="hero-reviews" href="https://share.google/FEhlEzh1JDaOMlqB0"><GoogleG size={26} /><span><GoogleStars value={4.9} size={16} /><span className="review-score"><b>4.9/5</b> from 247 Google Reviews</span></span><ArrowUpRight size={15} /></a></div><div className="hero-booking"><p className="hero-description">Trusted dental implants London clinic with highly experienced dentists. Get natural-looking, long-lasting dental implants with premium quality at affordable prices.</p><div className="hero-price"><span>From <strong>£2,950</strong></span><span className="price-divider" /><span>Or from <strong className="monthly">£67.80<small>/mo*</small></strong></span></div><div className="hero-buttons"><Button>Free 15-min chat</Button><Link className="text-link" href={booking}>1-hour consultation · £80<ArrowUpRight size={16} /></Link></div></div></div><HeroVideos /></div></section>
